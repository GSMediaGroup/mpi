...
class SendMail
{
    ...
    private function send()
    {
        try {
            ...
            $mail->addBCC('haruta@myperfectidea.net', 'Harut Agayan');
//            $mail->addBCC('grisha@myperfectidea.net', 'Grish');
//            $mail->addBCC('ellen@example.com');
    ...
    private function respond($errors = null)
    {
        $args = is_null($errors)
            ? ['status' => 'success']
